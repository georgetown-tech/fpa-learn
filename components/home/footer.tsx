      ...
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <a
              href="mailto:info@fairfieldprogramming.org"
              target="_top"
              className="max-w-xs text-gray-500 hover:underline"
            >
              info@fairfieldprogramming.org
            </a>
              ...
              >
                <ul className="space-y-4 text-sm">
                  <li className="text-right">
                    <Link
                      href="https://about.fairfieldprogramming.org/"
                      className="text-gray-700 transition hover:opacity-75"
                    >
                      About
                    </Link>
                  ...
                  <li className="text-right">
                    <Link
                      href="https://about.fairfieldprogramming.org/team"
                      className="text-gray-700 transition hover:opacity-75"
                    >
                      Meet the Team
                    </Link>
                  ...
                  <li className="text-right">
                    <Link
                      href="https://about.fairfieldprogramming.org/contact"
                      className="text-gray-700 transition hover:opacity-75"
                    >
                      Contact
                    </Link>
        ...
        <p className="text-xs text-gray-500">
          &copy; {new Date().getFullYear()}. The Fairfield Programming Association. All
          rights reserved.
        </p>
      </div>
    </footer>
