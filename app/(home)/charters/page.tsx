  ...
  return (
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="mx-auto aspect-video w-full max-w-3xl px-2">
          <CharterMap className="overflow-hidden rounded-xl border shadow" />
        </div>
        <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-12 lg:py-16">
          <h1 className="mb-4 mt-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
